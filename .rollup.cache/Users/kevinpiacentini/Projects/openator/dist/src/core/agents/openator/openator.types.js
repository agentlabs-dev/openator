...
export const JsonifiedManagerResponseSchema = JSON.stringify(zodToJsonSchema(ManagerAgentResponseSchema, 'ExpectedResponseFormat'));
...
`;
//# sourceMappingURL=openator.types.js.map