...
export const BrowserAgentActionSchema = z
  .union([
    z.object({
...
export const BrowserAgentResponseSchema = z.object({
  ...
  actions: z.array(BrowserAgentActionSchema),
});
...
export const JsonifiedManagerResponseSchema = JSON.stringify(
  zodToJsonSchema(BrowserAgentActionSchema, 'ExpectedResponseFormat'),
);

export const BrowserAgentResponseExamples = `
